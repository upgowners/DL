...
movies_df = pd.read_csv(C: // Users//ankit//Desktop//MSCIT//DL//DL//DL//Datasets//movies.dat',
                        sep='::', header=None, engine='python')
print(movies_df.head())

# Load the ratings dataset
ratings_df = pd.read_csv(
    C: // Users//ankit//Desktop//MSCIT//DL//DL//DL//Datasets//ratings.dat', sep=': : ', header=None, engine='python')
...
merged_df = merged_df.drop('Timestamp', axis=1).drop(
    'Title', axis=1).drop('Genres', axis=1)
...
for i in range(epochs):
    ...
    errors.append(sess.run(err_sum, feed_dict={
                  v0: trX, W: cur_w, vb: cur_vb, hb: cur_hb}))
    print(errors[-1])
plt.plot(errors)
plt.ylabel('Error')
plt.xlabel('Epoch')
...
print(scored_movies_df_50.sort_values(
