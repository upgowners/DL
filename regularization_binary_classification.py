...
model = keras.Sequential([
    ...
    keras.layers.Dense(16, activation=tf.nn.relu, kernel_regularizer=l2(
        0.001)),  # Hidden Layer 1 with relu as activation function
    keras.layers.Dense(16, activation=tf.nn.relu, kernel_regularizer=l2(
        0.001)),  # Hidden Layer 2 with relu as activation function
...
history = model.fit(X_train, y_train, validation_data=(
    X_train, y_train), epochs=50, batch_size=1)
